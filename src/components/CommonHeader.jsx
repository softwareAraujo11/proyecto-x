    ...
    return (
        <div className='CommonHeader'>
            <div id='div1-commonHeader'>
                <Link to="/Feed">
                    <img src={miLogo} alt="Logo" id='logoHeader' /> {/* Logo que redirige al Feed */}
                </Link>
            </div>
            ...
            <div id='div3-commonHeader'>
                <p onClick={handleLogout} id="logOut" style={{ cursor: 'pointer' }}>Log out</p> {/* Enlace de cierre de sesión */}
            </div>
        </div>
    );
};
