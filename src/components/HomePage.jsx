      ...
      <div className="homePage">
        ...
        <div className="principal-div">
          ...
          <div className="image-div">
            <img src={miLogo} alt="Logo" id="logoHome" /> {/* Muestra el logo */}
          </div>
          ...
          <div className="buttoms-div">
            ...
            <h2 id="text2">Join today.</h2> {/* Subtítulo animando al usuario a registrarse */}
            ...
            <div className="or-div">
              <hr className="line-or" /> {/* Línea horizontal antes del texto "or" */}
              <p>or</p> {/* Texto "or" que separa las opciones de registro */}
              <hr className="line-or" /> {/* Línea horizontal después del texto "or" */}
            </div>
            ...
            <p id="text3">
              ...
              <a href="https://x.com/en/tos">Terms of Services</a> and{" "} {/* Enlace a los Términos de Servicio */}
              <a href="https://x.com/en/privacy">Privacy Policy</a>, including{" "} {/* Enlace a la Política de Privacidad */}
              <a href="https://help.x.com/en/rules-and-policies/x-cookies">
                Cookie Use
              </a> {/* Enlace a la política de Cookies */}
              .
            </p>
