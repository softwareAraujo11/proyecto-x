...
function TweetPage({ addTweet }) {
    ...
    const handleTweetSubmit = () => {
        if (tweet.trim()) { // Verifica que el tweet no esté vacío.
        ...
        <div className='TweetPage'>
            <div className="container">
                ...
                <textarea 
                    ...
                    className="textarea"
                />
                {error && <p className="error">{error}</p>} {/* Mensaje de error si existe */}
                <button onClick={handleTweetSubmit} className="button">Publicar</button> {/* Botón para enviar el tweet */}
            </div>
        </div>
    );
}
